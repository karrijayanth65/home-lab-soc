...
## 📌 Why I placed the screenshots where I did

Notice the documentation follows the **same order in which we performed the investigation**:
...
2. AFTER configuration
        ↓
3. Windows generates 4688
        ↓
4. Wazuh receives it
        ↓
5. Examine Wazuh details
        ↓
6. Filter the noise
        ↓
7. Final detailed evidence
        ↓
8. Analyst conclusion
````

That makes the case very easy for someone visiting GitHub to follow.

### Your screenshot sequence

| # | Screenshot                                 | What the reader learns                 |
| - | ------------------------------------------ | -------------------------------------- |
| 1 | `PS_01_process_creation_audit_before.png`  | Why configuration had to be changed    |
| 2 | `PS_02_process_creation_audit_enabled.png` | Configuration was successfully enabled |
| 3 | `Win_01_event_4688.png`                    | Windows generated 4688                 |
| 4 | `Wazuh_01_event_4688_ingested.png`         | Wazuh received the event               |
| 5 | `Wazuh_02_event_4688_details.png`          | Wazuh contains process context         |
| 6 | `Wazuh_03_filtered_notepad_4688.png`       | We isolated our test from noise        |
| 7 | `Wazuh_04_filtered_event_details.png`      | Final proof of process + parent + rule |
